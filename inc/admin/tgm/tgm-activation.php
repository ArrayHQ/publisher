 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Publisher
...
add_action( 'tgmpa_register', 'publisher_register_required_plugins' );
 ...
 */
function publisher_register_required_plugins() {
	$plugins = array(
		array(
			'name'      => 'WPForms Lite',
			'slug'      => 'wpforms-lite',
 ...
 */
add_filter( 'wpforms_shareasale_id', 'publisher_wpforms_shareasale_id' );

function publisher_wpforms_shareasale_id( $shareasale_id ) {
